...
const (
	FeedService_Subscribe_FullMethodName = "/synoptic.feed.feed.FeedService/Subscribe"
)
...
func (c *feedServiceClient) Subscribe(ctx context.Context, in *SubscriptionRequest, opts ...grpc.CallOption) (FeedService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &FeedService_ServiceDesc.Streams[0], FeedService_Subscribe_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
const (
	IngressService_SubmitFeedMessage_FullMethodName  = "/synoptic.feed.feed.IngressService/SubmitFeedMessage"
	IngressService_SubmitFeedMessages_FullMethodName = "/synoptic.feed.feed.IngressService/SubmitFeedMessages"
)
...
func (c *ingressServiceClient) SubmitFeedMessage(ctx context.Context, in *FeedMessage, opts ...grpc.CallOption) (*SubmitFeedMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, IngressService_SubmitFeedMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ingressServiceClient) SubmitFeedMessages(ctx context.Context, opts ...grpc.CallOption) (IngressService_SubmitFeedMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &IngressService_ServiceDesc.Streams[0], IngressService_SubmitFeedMessages_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _IngressService_SubmitFeedMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngressService_SubmitFeedMessage_FullMethodName,
	}
